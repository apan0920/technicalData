...
jQuery(document).ready(function($) { 	
	...
	$('#ss_fb_dropdown').change(function() {
		...
		if(preview == "main") {
			window.location = "http://mpcthemes.net/flipbook/html/";
		} else if (preview == "brochure") {
			window.location = "http://mpcthemes.net/flipbook/html/" + preview + "/#3";
		} else {
			window.location = "http://mpcthemes.net/flipbook/html/" + preview + "/";
		} 
	});
	...
	$('#ss_background_pattern input').change(function() {
		...
		$('body').css('background-image', "url(http://mpcthemes.net/flipbook/html/"+pattern+")");
